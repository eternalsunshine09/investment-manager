...
<head>
    ...
    <title>Lupa Password - Porto Tracking</title>
    <style>
    * {
        margin: 0;
        padding: 0;
    ...
    <div class="container">
        <form class="form" action="{{ route('password.email') }}" method="POST">
            ...
            <div class="field">
                ...
                <input placeholder="Email Terdaftar" class="input-field" type="email" name="email"
                    value="{{ old('email') }}" required>
            </div>

            <button type="submit" class="button-main">Kirim Link Reset</button>
