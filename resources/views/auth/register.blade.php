...
<head>
    ...
    <title>Daftar - Porto Tracking</title>
    <style>
    * {
        margin: 0;
        padding: 0;
    ...
    <div class="container">
        <form class="form" action="{{ route('register') }}" method="POST">
            ...
            <div class="field">
                ...
                <input placeholder="Nama Lengkap" class="input-field" type="text" name="name" value="{{ old('name') }}"
                    required>
            </div>
            ...
            <div class="field">
                ...
                <input placeholder="Ulangi Password" class="input-field" type="password" name="password_confirmation"
                    required>
            </div>

            <button type="submit" class="button-main">Daftar Sekarang</button>

            <a href="{{ route('login') }}" class="link-back">Sudah punya akun? Masuk</a>
        </form>
    </div>
</body>
